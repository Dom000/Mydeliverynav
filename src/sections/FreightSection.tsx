...
const FreightSection = ({ className = "" }: FreightSectionProps) => {
    ...
    >
      ...
      <div ref={textRef} className="absolute left-[62vw] top-[26vh] w-[32vw]">
        ...
        <p className="text-[clamp(14px,1.1vw,17px)] text-muted-foreground leading-relaxed mb-8">
          FTL, LTL, and cross-border freight with clear documentation and
          customs support.
        </p>
        <a href="#freight-rates" className="text-link">
